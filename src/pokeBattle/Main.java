...
{
  private static Scanner scan_ = new Scanner(System.in);
  private static Pokemon mine_ = new Pokemon("TechTudo", PokemonType.WATER, 16);
  private static Pokemon opponent_ = new Pokemon("Charmander", PokemonType.FIRE, 16);
